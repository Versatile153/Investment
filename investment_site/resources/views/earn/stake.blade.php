...
<div class="cover hide"></div>    
  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-up" data-aos-delay="150">
     ...
     <div class="container-fluid end-divider bg-white">
...
<div class="container-fluid bg-white">
    <div id="top-ten-section" class="container default-wd ">
		...
		<div class="row fb-cus-row">
            ...
            <div class="col-sm-6 text_content-1 bg-white padding-left-40" style="padding-left:100px;">
            <div class="text-block1 bg-white">
			<p class="bg-white"> staking is only possible with cryptocurrencies linked to blockchains that use the proof-of-stake consensus mechanism.</p>
                    <div class="inner_text padding-30 bg-white text-white">
                        <ul style="padding-left: 0px; background-color:white; margin-left:0px!important;"><p></p>
      ...
      <td>
        <button type="button" class="btn btn-link btn-rounded btn-sm fw-bold" data-mdb-ripple-color="dark">
          ...
          <!-- End Schdule Day 2 -->
            ...
            <br><br>
                <!-- =======  F.A.Q Section ======= -->
    <section id="faq" class="bg-white text-dark">
