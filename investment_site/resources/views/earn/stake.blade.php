...
--------------------------------------------------------------*/
.call-to-action {
  background: linear-gradient(rgba(14, 29, 52, 0.6), rgba(14, 29, 52, 0.8)), url("https://media.istockphoto.com/id/1356756815/photo/crash-of-the-stock-exchanges.jpg?b=1&s=170667a&w=0&k=20&c=S4w9-mZE5RQ__EitkiSQ9hkmf_8cuKdhW9reFU_ddxM=") center center;
  background-size: cover;
  padding: 100px 0;
}
...
.testimonials {
  padding: 80px 0;
  background: url("https://media.istockphoto.com/id/1356756815/photo/crash-of-the-stock-exchanges.jpg?b=1&s=170667a&w=0&k=20&c=S4w9-mZE5RQ__EitkiSQ9hkmf_8cuKdhW9reFU_ddxM=") no-repeat;
...
.choose_bitcoin_area {
    background: url("https://media.istockphoto.com/id/1356756815/photo/crash-of-the-stock-exchanges.jpg?b=1&s=170667a&w=0&k=20&c=S4w9-mZE5RQ__EitkiSQ9hkmf_8cuKdhW9reFU_ddxM=");
    background-position: center;
    background-repeat: no-repeat;
    background-size: cover;
}
...
.footer_widgets_area {
    background: url("https://media.istockphoto.com/id/1356756815/photo/crash-of-the-stock-exchanges.jpg?b=1&s=170667a&w=0&k=20&c=S4w9-mZE5RQ__EitkiSQ9hkmf_8cuKdhW9reFU_ddxM=") no-repeat fixed center center;
    background-size: cover;
    height: auto;
...
<div class="cover hide"></div>    
  ...
  <section id="hero">
    ...
    <div id="section1" class="container default-wd mobile-padding-top1">
        <div class="title">
        <h2><p class="hidden-xs" style="padding-bottom:5px;font-size:28px; text-align:center;font-weight:600;">Stake with Primestocktrades Trading Limited</p></h2>
        </div>
        ...
        <div class="row fb-cus-row">
            ...
            <div class="text-block1"><p>Staking cryptocurrencies is a great way to diversify your portfolio and hedge risks. Primestocktrades Trading Limited has carved a niche for itself in it's staking pool.</p>
            </div>
            <div class="text-block2 padding-30"><p>Our soft-staking program allows you to easily generate rewards by simply holding your digital tokens on Primestocktrades. Staking rewards can be as high as 10%* for supported Digital Tokens.</p>
            </div>
            ...
            <ul class="faq-list">
              ...
              <li>
                ...
                <div id="faq5" class="collapse" data-bs-parent=".faq-list">
                  <p>
                   ...
                   Primestocktrades insures our clients from slashing and has never had a slashing event.</p>
                </div>
              </li>
              ...
              <li>
                ...
                <div id="faq6" class="collapse" data-bs-parent=".faq-list">
                  <p>
                   1. Easy to use: You don't need to manage private keys, acquire resources, make trades, or perform other complicated tasks to participate in DeFi Staking. Primestocktrades's one-stop service allows users to obtain generous online rewards without keeping an on-chain wallet. 2. No gas fee: Primestocktrades Staking deposits users’ funds into smart contracts on users’ behalf, saving users on-chain gas fees.</p>
                </div>
              </li>
