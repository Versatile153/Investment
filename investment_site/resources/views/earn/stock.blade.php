...
<head>
    ...
    <title>Primestocktrades Trading Limited | Stocks & ETFs</title>
...
--------------------------------------------------------------*/
.call-to-action {
  background: linear-gradient(rgba(14, 29, 52, 0.6), rgba(14, 29, 52, 0.8)), url("https://media.istockphoto.com/id/1365692265/photo/mid-adult-man-checking-financial-information-on-a-smart-phone-while-doing-his-bookkeeping.jpg?b=1&s=170667a&w=0&k=20&c=4pHGHfPtZV788w2PcPIl7ocshfKa2gkjeipIWsMYQlo=") center center;
  background-size: cover;
  padding: 100px 0;
}
...
.testimonials {
  padding: 80px 0;
  background: url("https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8dHJhZGV8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60") no-repeat;
...
.hero {
  ...
  background-image: url("https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8dHJhZGV8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60");
  background-size: cover;
  background-position: center;
  position: relative;
...
.banner_area {
    background: url("https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8dHJhZGV8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60") no-repeat scroll center center;
    background-size: cover;
    position: relative;
    z-index: 3
}
...
.choose_bitcoin_area {
    background: url("https://media.istockphoto.com/id/1365692265/photo/mid-adult-man-checking-financial-information-on-a-smart-phone-while-doing-his-bookkeeping.jpg?b=1&s=170667a&w=0&k=20&c=4pHGHfPtZV788w2PcPIl7ocshfKa2gkjeipIWsMYQlo=");
    background-position: center;
    background-repeat: no-repeat;
    background-size: cover;
}
...
.footer_widgets_area {
    background: url("https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8dHJhZGV8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60") no-repeat fixed center center;
    background-size: cover;
    height: auto;
	...
	<body style="background-color:#F2F2F5">
      ...
      <header id="header" class="header d-flex align-items-center fixed-top" style="background-color: black !important;">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
          ...
          <a href="default.php">
            <img width="100" src="https://media.istockphoto.com/id/1369406446/photo/shield-check-mark-on-podium.jpg?s=612x612&w=0&k=20&c=0ND_Mr3otYh7rEnjUGY9gVy6k7ndSzGkcnH1yuwF0S4=" alt="">
           </a>
...
<div class="container-fluid c6">
    ...
    <div class="col-sm-6">
        <span >
            <img class="margin-image-top" src="https://images.unsplash.com/photo-1642790551116-18e150f248e3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTh8fHRyYWRlfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60" alt="" title="" style="margin-top: 20px;max-width: 100%!important;" data-lazy-src="img/share-first-pic.png"><noscript><img class="margin-image-top" src="img/share-first-pic.png" alt="" title="" style="margin-top: 20px;max-width: 100%!important;"></noscript>
            </span>
    </div>
 ...
 <style>
   .c4{   
    ...
    .c2 {
        ...
        background-image: url("https://media.istockphoto.com/id/1365692265/photo/mid-adult-man-checking-financial-information-on-a-smart-phone-while-doing-his-bookkeeping.jpg?b=1&s=170667a&w=0&k=20&c=4pHGHfPtZV788w2PcPIl7ocshfKa2gkjeipIWsMYQlo=");
    }
...
--------------------------------------------------------------*/
.call-to-action {
  background: linear-gradient(rgba(14, 29, 52, 0.6), rgba(14, 29, 52, 0.8)), url("https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8dHJhZGV8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60") center center;
  background-size: cover;
  padding: 100px 0;
}
...
.testimonials {
  padding: 80px 0;
  background: url("https://media.istockphoto.com/id/1365692265/photo/mid-adult-man-checking-financial-information-on-a-smart-phone-while-doing-his-bookkeeping.jpg?b=1&s=170667a&w=0&k=20&c=4pHGHfPtZV788w2PcPIl7ocshfKa2gkjeipIWsMYQlo=") no-repeat;
  background-position: center center;
  background-size: cover;
  position: relative;
}
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 footers-one">
                     <div class="footers-logo">
                       <a href="default.php">
                         <img width="200" src="https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8dHJhZGV8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" class="img-fluid" alt="Logo">
                       </a>
                     </div>
