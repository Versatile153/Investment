...
<head>
    ...
    <title>Primestocktrades Trading Limited | Forex Trading</title>
...
<div class="cover hide"></div>    
  ...
  <section id="hero">
    ...
    <div id="section1" class="container default-wd mobile-padding-top1 bottom-divider">
        <div class="title">
            <h2><p class="hidden-xs" style="padding-bottom:5px;font-size:20px;text-align:center;font-weight:600;">Why Trade Forex with Primestocktrades Trading Limited</p>
			</h2>
        </div>
            ...
            <div class="title mobile-title-1">
                    <h2>
                        <p class="text-center" id = "headdig-textalign-right" style="text-align: left;font-size:32px!important;font-family: 'Helvetica Neue BD Pro',  sans-serif;">
                            Trade Forex with Primestocktrades Trading Limited
                        </p>
                    </h2>
                </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4 footers-one">
                     <div class="footers-logo">
                       <a href="default.php">
                         <img src="https://media.istockphoto.com/id/1341047641/photo/shot-of-a-group-of-businesspeople-sitting-against-an-orange-background.jpg?s=612x612&w=0&k=20&c=4wfr2lLjiNdywyxbqEUeg-2OBZ2PID1x7tnEYUzW5qU=" class="img-fluid" alt="Logo">
                       </a>
                     </div>
