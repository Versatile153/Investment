...
<head>
    ...
    <title>Primestocktrades Trading Limited | Pricing</title>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="read-more"><button class="btn-btn-primary" ><a href="cryptopricing.html"><i class="bi bi-arrow-right"></i> View Pricing</a></button></div>
              </div>
            </div>
