...
<head>
    ...
    <base href="https://primestocktrades.com/m_cust/dash/">
                    ...
                    <div class="dt-header__container">
                        ...
                        <div class="dt-brand">
                            ...
                            <span class="dt-brand__logo">
                                <a class="dt-brand__logo-link" href="https://primestocktrades.com/m_cust/dash/">
                                <img class="d-none d-sm-inline-block w-100" src="https://primestocktrades.com/m_cust/dash/uploads/prime24.png" alt="logo">
                                <img class="dt-brand__logo-symbol d-sm-none" src="https://primestocktrades.com/m_cust/dash/uploads/prime24.png" alt="logo">
                                </a>
                            </span>
                            <!-- /brand logo -->
                ...
                <main class="dt-main">
                    ...
                    <aside id="main-sidebar" class="dt-sidebar ps ps--active-y">
                            ...
                            <ul class="dt-side-nav">
                                    ...
                                    <a href="https://primestocktrades.com/m_cust/dash/dashboard"
                                ...
                                <li
                                    ...
                                    <ul class="dt-side-nav__sub-menu display-n">
                                        <li
                                            ...
                                            <a href="https://primestocktrades.com/m_cust/dash/deposits/new"
                                        ...
                                        <li class="dt-side-nav__item">
                                            <a href="https://primestocktrades.com/m_cust/dash/deposits"
                                                class="dt-side-nav__link "
                                                title="Revenue">
                                ...
                                <li
                                    ...
                                    <ul class="dt-side-nav__sub-menu display-n">
                                        <li
                                            class="dt-side-nav__item open ">
                                            <a href="https://primestocktrades.com/m_cust/dash/withdrawals/new"
                                                class="dt-side-nav__link "
                                                title="Traffic">
                                        ...
                                        <li class="dt-side-nav__item">
                                            <a href="https://primestocktrades.com/m_cust/dash/withdrawals"
                                                class="dt-side-nav__link "
                                                title="Revenue">
                                ...
                                <li
                                    class="dt-side-nav__item ">
                                    <a href="https://primestocktrades.com/m_cust/dash/earnings"
                                        class="dt-side-nav__link "
                                        title="Earnings">
                                        <i class="icon icon-dashboard icon-fw icon-lg"></i>
                                ...
                                <li
                                    class="dt-side-nav__item ">
                                    <a href="https://primestocktrades.com/m_cust/dash/referrals"
                                        class="dt-side-nav__link "
                                        title="My Referrals">
                                ...
                                <li
                                    class="dt-side-nav__item ">
                                    <a href="https://primestocktrades.com/m_cust/dash/tickets" class="dt-side-nav__link"
                                        title="Support">
                    ...
                    <div class="col-md-12">
                            ...
                            <div class="card-body p-6">
                                ...
                                <a class="btn btn-default btn-sm text-dark"
                                    href="https://primestocktrades.com/m_cust/dash/profile">Setup</a>
                            </div>
                            <!-- /card body -->
                        </div>
                        ...
                        <div
                            ...
                            <div class="bg-overlay__inner mt-auto">
                                ...
                                <div class="dt-card__body">
                                    ...
                                    <form action="https://primestocktrades.com/m_cust/dash/invite" method="post" id="joinForm"
                                        name="joinForm">
                                        <form action="https://primestocktrades.com/m_cust/dash/invite" id="joinForm" method="post" accept-charset="utf-8">
                        ...
                        <div class="dt-card">
                            ...
                            <div class="dt-card__header mb-4">
                                ...
                                <div class="dt-card__tools">
                                    <a href="https://primestocktrades.com/m_cust/dash/earnings" class="dt-card__more">Detailed history</a>
                                </div>
                                <!-- /card tools -->
                                    ...
                                    <table class="table table-ordered table-bordered-0 mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-uppercase text-right" scope="col">Amount (GBP)
                                                </th>
